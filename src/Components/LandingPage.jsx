...
export const LandingPage = forwardRef((props, ref) => {
    ...
    return (
        <div className="font-rock_salt lg:bg-[url('/images/hero.jpeg')] bg-[url('/images/Ryan-RGL.jpeg')] bg-cover bg-center bg-fixed h-screen w-full text-white flex flex-col justify-between items-center" ref={ref}>        
