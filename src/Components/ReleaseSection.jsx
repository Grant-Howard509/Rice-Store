...
export const ReleaseSection = forwardRef((props, ref) => {
    return(
        // <div className='bg-white h-screen w-full sm:p-20 p-16'>
            <div className="flex 2xl:flex-row flex-col justify-center items-center w-full h-screen sm:p-20 p-16" ref={ref}>
                ...
                {/* Create another flex-item with background image: must fit viewport */}

                {/* <div className="md:w-560 sm:w-96 w-80  cursor-pointer overflow-hidden">
